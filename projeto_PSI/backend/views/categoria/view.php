...
<div class="categoria-view container mt-5">
    ...
    <div class="card shadow-lg rounded-4 border-0" style="background: linear-gradient(135deg, #ffffff, #f0f8ff);">
        <div class="card-header bg-dark text-white rounded-top-4 d-flex justify-content-between align-items-center">
            <span class="fs-5 fw-bold">Detalhes da Categoria</span>
        </div>
        ...
        <div class="card-body">
            <?= DetailView::widget([
                    ...
                    'attributes' => [
                            ...
                            [
                                    'attribute' => 'id_gestor',
                                    'label' => 'ID do Gestor',
                                    'contentOptions' => ['class' => 'text-center text-secondary fw-bold'],
                            ],
                    ],
            ]) ?>
            ...
            <div class="mt-4 d-flex gap-3">
                ...
                <?= Html::a('Apagar', ['delete', 'id' => $model->id], [
                        ...
                        'data' => [
                                'confirm' => 'Tem a certeza que deseja apagar esta Categoria?',
                                'method' => 'post',
                        ],
                ]) ?>
