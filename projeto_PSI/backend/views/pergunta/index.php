...
/** @var common\models\PerguntaSearch $searchModel */
...
<div class="pergunta-index">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <?= Html::a('<i class="fas fa-plus"></i> Criar Pergunta', ['create'],
                            ...
                            'buttons' => [
                                    ...
                                    'delete' => function($url) {
                                        return Html::a('<i class="fas fa-trash"></i>', $url, [
                                                ...
                                                'title' => 'Apagar',
                                                'data-confirm' => 'Tens a certeza que deseja apagar esta Pergunta?',
                                                'data-method' => 'post',
                                        ]);
                                    },
                            ],
