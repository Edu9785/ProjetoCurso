...
/**
 * JogodefaultSearch represents the model behind the search form of `common\models\Jogodefault`.
 */
class JogodefaultSearch extends Jogodefault
{
    /**
     * {@inheritdoc}
     */
